...
<body>
	...
	<div id="layer03_holder">
	  ...
	  <tr>
		<td colspan="2">LOGIN FOR TEACHER</td>
	...
	<tr>
		  ...
		  <?php 
		require ("../01-for login page/db.php");
		$error = "";
		...
		{ 			
			...
			// sending query		
			$result = mysql_query("SELECT * FROM teacher WHERE UserName = '$UserName' AND Password = 
						   '$Password'");
			...
			$row = mysql_fetch_array($result);					
				...
				else if ($numberOfRows > 0) 
				{
					...
					$_SESSION['Tuserid']=$row['teacherid'];
...
<div id="layer04_holder">
  ...
  If you forgot your password, please contact the Registrar's Office. Click Here to Log-in for 
  <br>
  <a href="../index.php">Student.</a>
  <em>Click Here To Log-in For Students.</em>
  ,<a href="../01-for login page/index.php">Admin</a><em>Click Here To Log-in For The Admin.</em>
