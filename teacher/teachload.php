...
<table id="demoTable" style="border: 1px solid #ccc;" cellspacing="0" width="550" bgcolor="#FFFFFF">
        <thead >
                <tr>
                        <th sort="index" align="center"><span class="style7">Course</span></th>
                        <th sort="date" align="center"><span class="style7">SchYR</span></th>
                        <th sort="description" align="center"><span class="style7">Sem</span></th>
...
<br />		
<table id="demoTables" style="border: 1px solid #ccc;" cellspacing="0" width="550" bgcolor="#FFFFFF">
        <thead >
                <tr>
                        
                        <th sort="description" align="center"><span class="style7">Year</span></th>
                     
						 <th sort="description" align="center"><span class="style7">Section</span></th>
        ...
        <tbody>
		 <?php
			include("db.php");
			$id =$_SESSION['Tuserid'];
			$result=mysql_query("SELECT * FROM tload WHERE teacherid ='$id'");
