...
{	
	...
	mysql_query("UPDATE student SET	 UserName ='$user_save', Password ='$pass_save', 
	contactnumber ='$contact_save', firstname= '$first_save', lastname = '$last_save',  middlename= '$middle_save', address='$address_save' WHERE studentID = '$id'")
				or die(mysql_error()); 
	echo "Saved!";
...
<div id="templatemo_content_right">
	   ...
	   $uh=mysql_query("SELECT * FROM student WHERE studentID='$studentID'");
