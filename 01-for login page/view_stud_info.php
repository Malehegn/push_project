...
<?php include('db.php');
				...
				// echo "<th style='width: 195px;'><font color='green'>Program</font></th>";
				 ...
				 echo "<td><strong><font color='green'><center>".$rowses['Password']."</strong></a></td>";
				 ...
				 $resultz=mysql_query("SELECT program.programtitle FROM student LEFT JOIN program ON student.programId=program.programId LIMIT 0,1 ");
				 	while($testz = mysql_fetch_array($resultz))
					{	
				// echo "<td><strong><font color='green'><center>".$testz['programtitle']."</strong></td>";
				 	}
				 echo "</tr>";
				 echo "</table>";
				 echo "<br>"; 
