...
<div id="templatemo_content_right" style="margin-right: 165px;">
		  ...
		  <h1> Update Teacher's Profile </h1>
...
<?php include('db.php');
				...
				$resultses = mysql_query("SELECT * FROM teacher WHERE UserName = '$idnum' LIMIT 0,1 ");
				...
				while($rowses = mysql_fetch_array($resultses))
				 ...
				 echo "<th style='width: 195px;'><font color='green'>address </font></th>";
				 echo "<th style='width: 195px;'><font color='green'>contact No</font></th>";
				 echo "<th style='width: 5px;'><font color='green'>Update</font></th>";
				 echo "</tr>";
				 echo "<tr bgcolor='#f7f6c9'>";
				 echo "<td><strong><font color='green'>".$rowses['UserName']."</strong></td>";
				 echo "<td><strong><font color='green'>".$rowses['password']."</strong></td>";
				 echo "<td><strong><font color='green'>". $rowses['firstname'].'&nbsp;'.$rowses['middlename'].'&nbsp;'.$rowses['lastname']. "</strong></td>";
				 echo "<td><strong><font color='green'>".$rowses['address']."</strong></td>";
				 echo "<td><strong><font color='green'>".$rowses['contactnum']."</strong></td>";
				 echo"<td> <a href ='update_teacher(code).php?teacherid=$id'><center><img src='images/2.png' onClick='return confirm('Are you sure you want to update this record?')'></center></a>";		
				 echo "</tr>";
				 echo "</table>";
				 echo "<br>"; 
				 }
 ...
 <table id="demoTable" style="border: 1px solid #ccc;" cellspacing="0" width="700" bgcolor="#FFFFFF">
        <thead >
                <tr>
                        ...
                        <th sort="description"><span class="style7">Contact Number</span></th>
                        <th sort="beds"><span class="style7">Name</span></th>
                        <th sort="maxGuests"><span class="style7">Address</span></th>
                        <th sort="average"><span class="style7">Date Added</span></th>
						<th sort="average"><span class="style7">Update</span></th>
        ...
        <tbody>
			...
			while($test = mysql_fetch_array($result))
			{
				...
				echo"<td><font color='black'>". $test['contactnum']. "</font></td>";
...
<table>
	<tr>
		<td>	
			<form id="form1" name="form1" method="post" action="add_teacher_info.php" >
            <label>
            <input type="submit" name="vtedit" value="ADD" class="btn" />
            </label>
			</form>
		</td>
		<td>
			<form method="post" action="view_teacher.php">
            <label>
