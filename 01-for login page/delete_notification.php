...
<div id="templatemo_content_right" style="margin-right: 185px;">
	...
	<?php include('db.php');
				...
				echo "<th style='width: 0px;'><font color='green'>Delete</font></th>";
				 echo "</tr>";
				...
				// echo "<td><strong><center><font color='green'>".$rowses['dateadded']."</center></strong></td>";
				 echo"<td> <a href ='del_notification(code).php?id=$id'><center><img src='images/9.png' onClick='return confirm('Are you sure you want to delete this record?')'></center></a>";	
