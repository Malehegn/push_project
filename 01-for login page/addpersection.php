...
<div id="templatemo_container">
    ...
    <div id="templatemo_content">
      <div id="templatemo_content_right">
	   <h1><strong> 2nd Step:Add Load For Student</strong></h1>
...
if (isset($_POST['addsemload']))
	...
	include 'db.php';
		 ...
		 mysql_query("INSERT INTO `studsemtemp`(studentID,schyr,sem,year,section,program,major,courseID) 
		 VALUES ('$id','$schyr','$sem','$yr','$section','$progID','$major','$course')"); 
