...
<div id="templatemo_content_right" style="margin-right: 165px;">
		  ...
		  <h1> Delete Teacher's Profile and Load </h1>
...
<?php include('db.php');
				...
				while($rowses = mysql_fetch_array($resultses))
				 ...
				 echo"<td> <a href ='del_teacher(code).php?teacherid=$id'><center><img src='images/9.png' onClick='return confirm('Are you sure you want to delete this program?')'></center></a>";		
				 echo "</tr>";
				 echo "</table>";
				 echo "<br>"; 
				 }
 ...
 <table id="demoTable" style="border: 1px solid #ccc;" cellspacing="0" width="700" bgcolor="#FFFFFF">
        <thead >
                <tr>
						...
						<th sort="average"><span class="style7">Delete</span></th>
