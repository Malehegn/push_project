...
<?php include('db.php');
		   ...
		   <table id="demoTable" style="border: 1px solid rgb(204, 204, 204);table-layout: fixed;" cellspacing="0" width="700" bgcolor="#FFFFFF">
        <thead >
                <tr>
                    
                        <th sort="date"><span class="style7">Program Tittle</span></th>
                        <th sort="description" style="width: 360px;"><span class="style7">Program Description</span></th>
        ...
        <tfoot class="nav">
				...
				<tr>
			  <td><form id="form1" name="form1" method="post" action="edit_prog.php" >
				<label>
				<input type="submit" name="vpedit" value="Click Here to Edit"class="btn" />
				</label>
				</form>
				</td><td>&nbsp;</td>
				<td>
				...
				<label>
				<input type="submit" name="vpdel" value="Click Here to Delete" class="btn" />
				</label>
			  </form>
			  </td></tr>
        </tfoot>
