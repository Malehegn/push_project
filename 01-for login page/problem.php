...
<h1>View student Problem</h1>
       	  
		  <table id="demoTable" style="border: 1px solid #ccc;" cellspacing="0" width="700" bgcolor="#FFFFFF">
        <thead >
                <tr>
                       
                        <th sort="date"><span class="style7">Teacher Name</span></th>
							<th sort="description"><span class="style7">Course</span></th>
                        <th sort="description"><span class="style7">Student Name</span></th>
					
						<th sort="description"><span class="style7">Problem</span></th>
						<th sort="description"><span class="style7">Update</span></th>
        ...
        <tbody>
          ...
          <?php
			include("db.php");
			$id =$_SESSION['Tuserid'];
			$result=mysql_query("SELECT * FROM report WHERE status=1");
			...
			while($test = mysql_fetch_array($result))
			{
				...
				$courseid=$test['courseID'];
					$getteach=mysql_query("SELECT * FROM teacher WHERE teacherid='$tid'") or die(mysql_error());
					$getthis2=mysql_fetch_array($getteach);
			
				echo"<td><font color='black'>". $getthis2['firstname']." ".$getthis2['middlename']; "</font></td>";
				...
				echo"<td> <a href ='edit_stud(code).php?studentID=$id'><center><img src='images/2.png' onClick='return confirm('Are you sure you want to update this record?')'></center></a>";	
				echo"<td> <a href ='del_prob.php?id=$id'><img src='images/9.png'></a>";
				echo "</tr >";	
