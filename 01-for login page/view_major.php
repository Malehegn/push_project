...
<div id="templatemo_content_right" style="margin-right: 132px;">
	...
	<?php include('db.php');
				...
				while($rowses = mysql_fetch_array($resultses))
				 ...
				 echo "<tr bgcolor='#f7f6c9'>";
					...
					{	
				 echo "<td><strong><font color='green'>".$test['programtitle']."</strong></td>";
				 	}
	...
	<?php 
		...
		echo "<tr align='center'>";	
				...
				echo"<td><font color='black'>" .$test['dateadded']."</font></td></tr>";
		}	
	?>
	 ...
	 <br />
	 	<table>
		<tr>
          <td><form id="form1" name="form1" method="post" action="edit_major.php" >
            <label>
			...
			<td>
			<form method="post" action="delete_major.php">
            <label>
