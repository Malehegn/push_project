...
<div id="templatemo_content_right" style="margin-right: 132px;">
	<h1>Activated Student's Account</h1>
...
<?php include('db.php');
				...
				$resultses = mysql_query("SELECT * FROM student WHERE UserName = '$idnum' AND status=1 ");
				$i=0;
				...
				// $teh=mysql_query("SELECT * FROM studsem WHERE studentID = '$id' AND status=1 ") or die(mysql_error());
				...
				// echo"<td><font color='green'><center>". $var['program']. "</center></font></td>";
				 ...
				 echo"<td> <center><a href ='deactivate(code2).php?studentIDs=$idah'><img src='images/53.png'></a></center>";
				 echo "</tr>";
        ...
        <thead >
                <tr>
						...
						<th sort="total"><span class="style7">Activated</span></th>
        ...
        <tbody>
			...
			$result=mysql_query("SELECT * FROM student WHERE status=1 ORDER BY UserName ASC") or die(mysql_error());
			...
			while($test = mysql_fetch_array($result))
			{
				...
				echo"<td> <center><a href ='deactivate(code).php?studentID=$id'><img src='images/53.png'></a></center>";										
				echo "</tr>";
