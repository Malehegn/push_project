...
<div id="templatemo_content_right" style="margin-right: 185px;">
	...
	<?php include('db.php');
				...
				while($rowses = mysql_fetch_array($resultses))
				 ...
				 echo "<th style='width: 0px;'><font color='green'>DateAdded</font></th>";
				 echo "</tr>";
				...
				// echo "<td><strong><center><font color='green'>".$rowses['unit']."</center></strong></td>";
				 ...
				 echo"<td> <a href ='del_course(code).php?courseID=$id'><center><img src='images/9.png' onClick='return confirm('Are you sure you want to delete this program?')'></center></a>";	
	...
	<br /></center><br />
        ...
        <thead >
                <tr>
                        ...
                        <th sort="average"><span class="style7">Course Code</span></th>
                        <!--<th sort="total"><span class="style7">Pre-Requesit</span></th> -->
						<th sort="total"><span class="style7">Course Description</span></th>
						<th sort="beds"><span class="style7">Hrs/Week</span></th>
	 ...
	 <br />
	 	<table>
		<tr>
          <td><form id="form1" name="form1" method="post" action="edit_course.php" >
            <label>
