...
<div id="templatemo_container">
    ...
    <div id="templatemo_content">
      <!-- end of content left -->
<div id="templatemo_content_right" style="margin-right: 185px;">
		<h1> Delete Notifications </h1>
		<center>	  
	<form method="post">
	<input type="text" 
			name="notid" 
			placeholder="Notifications ID" 
			onclick="if(this.value=='Notifications ID'){this.value=''}" 
			onblur="if(this.value==''){this.value='Notifications ID'}" 
	...
	<?php include('db.php');
				...
				// echo "<td><strong><center><font color='green'>".$rowses['dateadded']."</center></strong></td>";
				 echo"<td> <a href ='edit_notification(code).php?id=$id'><center><img src='images/2.png' onClick='return confirm('Are you sure you want to delete this record?')'></center></a>";	
	 ...
	 <br />
		...
		<tr>
          <td><form id="form1" name="form1" method="post" action="edit_notification.php" >
			...
			<td>
			<form method="post" action="view_notification.php">
            <label>
