...
<?php include('db.php');
				...
				while($rowses = mysql_fetch_array($resultses))
				 ...
				 echo"<td> <a href ='edit_program(code).php?programId=$id'><img src='images/2.png'></a>";
        ...
        <thead >
                <tr>
						...
						<th sort="beds"><span class="style7">Edit</span></th>
		...
		<table>
			<tr>
			<td>
            <form id="form1" name="form1" method="post" action="delete_prog.php" >
            <label>
              <input type="submit" name="epdel" value="Delete" class="btn" />
            </label>
			</form></td>
			<td>
