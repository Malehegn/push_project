...
<!DOCTYPE html >
<html >
<script type="text/javascript" src="student/jquery.js"></script>
...
<link rel="shortcut icon" href="student/images/chmsc.png">
<link rel="icon" href="student/images/chmsc.png" type="image/png" >
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Log-In students</title>
<link href="student/stylelog.css" rel="stylesheet" type="text/css" />
</head>
...
<body>
	...
	<div id="layer03_holder">
	  ...
	  <table width="100%" >
	  <tr>
		<td colspan="2">LOGIN FOR STUDENT</td>
	  </tr>
	  ...
	  <tr>
		...
		{ 			
			...
			// sending query		
			$result = mysql_query("SELECT * FROM student WHERE UserName = '$UserName' AND Password = 
			...
			$row = mysql_fetch_array($result);					
				...
				else if ($numberOfRows > 0) 
				{
					...
					$_SESSION['is']['SUserName'] = $_POST['UserName'];									
...
<div id="layer04_holder">
  ...
  If you forgot your password, please contact the Registrar's Office. Click Here to Log-in for<br /><a href="teacher/index.php">Teacher</a>
   <em>Click Here To Log-in For Teacher.</em>,<a href="01-for login page/index.php">Admin</a><em>Click Here To Log-in For The Admin.</em></div></div>
  <div id="right"></div>
</div>
